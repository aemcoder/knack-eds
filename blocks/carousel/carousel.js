 ...
 * Adapted: no placeholders.js dependency (single-language site),
 * added `logos` variant (auto-scrolling logo strip, no controls).
 */

function decorateLogosVariant(block) {
  const track = document.createElement('ul');
  track.className = 'carousel-logos-track';
  [...block.children].forEach((row) => {
    const li = document.createElement('li');
    li.className = 'carousel-logo';
    li.append(...row.querySelectorAll('picture, img'));
    track.append(li);
    row.remove();
  });
